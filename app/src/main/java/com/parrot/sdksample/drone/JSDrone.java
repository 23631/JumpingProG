...
public class JSDrone {
    ...
    public void testAction() {
        mDeviceController.getFeatureJumpingSumo().sendMediaRecordPictureV2();
        setSpeed((byte)5);
        mDeviceController.getFeatureJumpingSumo().setPilotingPCMDFlag((byte) 1);
    ...
    public void testAction2() {
                mDeviceController.getFeatureJumpingSumo().sendMediaRecordPictureV2();
                mDeviceController.getFeatureJumpingSumo().setPilotingPCMDSpeed((byte) 0);
                mDeviceController.getFeatureJumpingSumo().setPilotingPCMDFlag((byte) 0);
    }
    ...
    public void animation(ARCOMMANDS_JUMPINGSUMO_ANIMATIONS_SIMPLEANIMATION_ID_ENUM animation) {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureJumpingSumo().sendAnimationsSimpleAnimation(animation);
        }
    }

    public void jump(ARCOMMANDS_JUMPINGSUMO_ANIMATIONS_JUMP_TYPE_ENUM jump) {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureJumpingSumo().sendAnimationsJump(jump);
        }
    }
